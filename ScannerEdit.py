...
m1.add_command(label = 'Scan/Upload Business cards and get all the text of cards',
               font = ('Times', 13))
root.config(menu = mainmenu)
mainmenu.add_cascade(label = 'Aim', menu = m1)
#
m2 = Menu(mainmenu, tearoff = 0)
m2.add_command(label = '|| Python Developer ||', 
               font = ('Times', 13))
m2.add_command(label = '|| Tech Enthusiast ||', font = ('Times', 13))
root.config(menu = mainmenu)
mainmenu.add_cascade(label = 'About us', menu = m2)

m3 = Menu(mainmenu, tearoff=0)
m3.add_command(label = 'nitishbhatia1642@gmail.com', 
               font = ('Times', 13))
m3.add_separator()
m3.add_command(label = 'Mobile: +9821983009', font=('Times', 13))

#
root.config(menu = mainmenu)
mainmenu.add_cascade(label = 'Contact us', menu = m3)

Label(text = 'Business Card Reader', bg = '#FAD2B8',
      fg = "#165FE6", font = ('Times', 20)).pack(fill = 'x')
...
Label(text='©copyright 2025', bg='#433E3B', fg='white',
      font=('Times', 10)).pack(side='bottom', fill='x')
Label(text='Developer: Nitish Bhatia', bg='#433E3B', fg='white',
...
Button(root, text='Scan and Convert', bg="#7CFF4C", font=('Times', 15),
